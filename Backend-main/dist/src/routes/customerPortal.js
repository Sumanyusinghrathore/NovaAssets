...
const PORTAL_ACTIVE_STATUSES = ["Assigned to Engineer", ...complaintRules_1.IN_PROGRESS_COMPLAINT_STATUSES, "Escalated to L2", "Escalated to L3", "Spare Requested", "Dispatch in Progress"];
...
router.post("/complaints", runCustomerPortalPictureUpload, async (req, res) => {
    ...
    const complaint = {
        ...
        status: assignmentDecision?.status ?? complaintRules_1.OPEN_COMPLAINT_STATUSES[0],
